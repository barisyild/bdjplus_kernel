...
public class JavaSecurityProxy implements JavaSecurityAccess {
    JavaSecurityAccess real;
    public JavaSecurityProxy(JavaSecurityAccess r)
    {
        real = r;
    }
    ...
    public String getEngineName(Object a) {
        return null;
    }
