...
public class NativeUtils
{
    ...
    {
        BDJModule.log("Reading resource: " + name);
    ...
    private static void init() throws Exception
    {
        ...
        {
            byte[] data = readResource("/com/bdjplus/kernel/NativeLAcces.class");
            replaceBytesString(data,
               "com/bdjplus/kernel/ClassLoader_NaLi",
                "java/lang/ClassLoader$NativeLibrary"
            );
            replaceBytesString(data,
               "com/bdjplus/kernel/NativeLAcces",
        ...
        {
            byte[] data = readResource("/com/bdjplus/kernel/UAcce.class");
            replaceBytesString(data,
               "com/bdjplus/kernel/UAcce",
